...
$('.infus-supply .supply-main').on('click',function(){
	...
	let GetButtonText = $(this).find('.button-text-hidden').text();
	let GetSoldoutText = document.querySelector('.sold-out-txt');
	...
	if (GetSoldoutText) {
		...
		{
			GetSoldoutText.style.display = 'none';
		}
	}
	...
	if(GetPriceSave)
	{
		...
		$('.satisfaction-form .treatment-buy__button').text(GetButtonText + ' & ' + GetPriceSave);
	}
	else 
	{
		$('.satisfaction-form .treatment-buy__button').text(GetButtonText);
	}
...
$('.supply-month .supply-link').on('click',function(){
	...
	let GetButtonText = $(this).find('.button-text-hidden').text();
	let GetSoldoutText = document.querySelector('.sold-out-wrapper');
	...
	if(GetPriceSave)
	{
		...
		$('.supply-detail .treatment-buy__button').text(GetButtonText + ' & ' + GetPriceSave);
	}
	else 
	{
		$('.supply-detail .treatment-buy__button').text(GetButtonText);
	}
});
...
$("body").on( "click", ".formula-info .accordion__title, .formula-area .accordion__title, .question-ans .accordion__title, .serum_accordian .accordion__title", function() {
